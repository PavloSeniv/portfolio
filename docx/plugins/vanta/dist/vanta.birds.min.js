    ...
    return function (t) {
        ...
        0: function (t, e, i) {
            ...
            const l = t => document.querySelector(t),
                h = t => "number" == typeof t ? "#" + ("00000" + t.toString(16)).slice(-6) : t, c = (t, e = 1) => {
                    const i = h(t), n = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i),
            ...
            r.VantaBase = class {
                constructor(t = {}) {
                    ...
                    if (this.options = Object(n.c)({
                        ...
                        scale: 1,
                        scaleMobile: 1
                    }, e), (t instanceof HTMLElement || "string" == typeof t) && (t = {el: t}), Object(n.c)(this.options, t), this.options.THREE && (s = this.options.THREE), this.el = this.options.el, null == this.el) a('Instance needs "el" param!'); else if (!(this.options.el instanceof HTMLElement)) {
                        const t = this.el;
                ...
                windowMouseMoveWrapper(t) {
                    ...
                    if (!e) return !1;
                    const i = t.clientX - e.left, n = t.clientY - e.top;
                ...
                windowTouchWrapper(t) {
                    ...
                    if (1 === t.touches.length) {
                        const i = t.touches[0].clientX - e.left, n = t.touches[0].clientY - e.top;
                        i >= 0 && n >= 0 && i <= e.width && n <= e.height && (this.mouseX = i, this.mouseY = n, this.options.mouseEase || this.triggerMouseMove(i, n))
                    }
                }
                ...
                windowGyroWrapper(t) {
                    const e = this.getCanvasRect();
                    if (!e) return !1;
                    const i = Math.round(2 * t.alpha) - e.left, n = Math.round(2 * t.beta) - e.top;
                    i >= 0 && n >= 0 && i <= e.width && n <= e.height && (this.mouseX = i, this.mouseY = n, this.options.mouseEase || this.triggerMouseMove(i, n))
                }
                ...
                triggerMouseMove(t, e) {
                    ...
                    const i = t / this.width, n = e / this.height;
                ...
                isOnScreen() {
                    const t = this.el.offsetHeight, e = this.el.getBoundingClientRect(),
                ...
                s.add(b), this.setDataType = function (t) {
                    ...
                    for (var n = 0; n < this.variables.length; n++) {
                        ...
                        if (null !== o.dependencies) for (var a = 0; a < o.dependencies.length; a++) {
                            ...
                            r[l.name] = {value: null}, s.fragmentShader = "\nuniform sampler2D " + l.name + ";\n" + s.fragmentShader
                        }
                    }
            ...
            const C = function (t) {
                    (z = function (e = {}) {
                        ...
                        var i, n, o = new t.Vector3, s = 500, r = 500, a = 200, l = e;
                        this.position = new t.Vector3, this.velocity = new t.Vector3, i = new t.Vector3, this.setGoal = function (t) {
                            ...
                            var i, n, o = new t.Vector3, s = new t.Vector3, r = 0;
                            ...
                            var i, n, o = new t.Vector3, s = new t.Vector3;
                ...
                D = function (t) {
                    ...
                    return (() => {
                        const t = [];
                        for (; i < n;) {
                            const n = Math.random() * M - T, o = Math.random() * M - T, s = Math.random() * M - T;
            ...
            class A extends n.b {
                ...
                getNewCol(t) {
                    const e = this.options, i = null != e.color1 ? e.color1 : 4456448,
                        n = null != e.color2 ? e.color2 : 6684672, o = new g.Color(i), s = new g.Color(n);
                    let r, a;
                    if (a = -1 != e.colorMode.indexOf("Gradient") ? Math.random() : t, 0 == e.colorMode.indexOf("variance")) {
                        const t = (o.r + Math.random() * s.r).clamp(0, 1), e = (o.g + Math.random() * s.g).clamp(0, 1),
                ...
                onInit() {
                    ...
                    const t = this.birds = [], e = this.boids = [], i = this.options;
                    let n, o;
                    if (w) try {
                        ...
                        for (var s = 0; s < l; s++) {
                            ...
                            const h = -1 != i.colorMode.indexOf("Gradient"), c = new z(i);
                            for (var r = 0; r < c.faces.length; r++) if (h) for (var a = 0; a < 3; a++) {
                ...
                onUpdate() {
                    ...
                    if (t > 1 && (t = 1), this.last = this.now, w) this.positionUniforms.time.value = this.now, this.positionUniforms.delta.value = t, this.velocityUniforms.time.value = this.now, this.velocityUniforms.delta.value = t, this.birdUniforms.time.value = this.now, this.birdUniforms.delta.value = t, this.velocityUniforms.predator.value.set(this.mouseX, -this.mouseY, 0), this.mouseX = 1e4, this.mouseY = 1e4, this.gpuCompute.compute(), this.birdUniforms.texturePosition.value = this.gpuCompute.getCurrentRenderTarget(this.positionVariable).texture, this.birdUniforms.textureVelocity.value = this.gpuCompute.getCurrentRenderTarget(this.velocityVariable).texture; else {
                        const t = this.birds, n = this.boids;
                        let o, s;
